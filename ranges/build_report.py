...
def build():
    ...
    vrows = "".join([
        verdict_row("Swings land on levels",
                    "141,719 swings, R=2187, tol &#177;0.5pp", p["z_phase"]),
        verdict_row("&#8230; best of all 60 phases",
                    "phase-agnostic, robust to the cash&#8211;futures basis", p["z_adjmax"]),
        verdict_row("Levels produce a reaction",
                    "9,362 deduplicated touches, 60&#8209;minute horizon", rx60["z_phase"]),
        verdict_row("Block edges sweep and reject",
                    "817 boundary crossings, R=2187", sweep2187["z_phase"]),
        verdict_row("Price lingers in rebalance",
                    "share of closes inside [41&#8211;59]", dwell_reb["z_phase"]),
        verdict_row("Strongest cell, 144 grid tests",
                    "R=729, k=10, tol 0.5pp &#8212; the best of 144", grid_max),
    ])
